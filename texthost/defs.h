...
constexpr auto ITH_DLL_X86 = L"libs\\x86\\texthook"; // .dll but LoadLibrary automatically adds that
constexpr auto ITH_DLL_X64 = L"libs\\x64\\texthook"; // .dll but LoadLibrary automatically adds that
